...
def deprecated_callable_import(trac_number, module_name, globs, locs, fromlist, message=None):
    ...
    EXAMPLES::
       ...
       True
       sage: del is_prime
       sage: deprecated_callable_import(13109, 'sage.arith', globals(), locals(), ['is_prime'])
       sage: is_prime(3)
       doctest:...: DeprecationWarning:
       Using is_prime from here is deprecated.  If you need to use it, please import it directly from sage.arith.
       See http://trac.sagemath.org/13109 for details.
       True
    """
    _check_trac_number(trac_number)
